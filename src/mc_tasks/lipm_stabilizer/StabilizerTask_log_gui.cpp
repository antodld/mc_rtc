...
void StabilizerTask::addToGUI(mc_rtc::gui::StateBuilder & gui)
{
  ...
  gui.addElement(
      {"Tasks", name_, "Debug"}, ElementsStacking::Horizontal,
      Button("Plot Left CoP Model Tracking (y)",
             [this, &gui]() {
               gui.addPlot("Left CoP Model Tracking (y)", plot::X("t", [this]() { return t_; }),
                           plot::Y(
                               "support_min",
                               [this]() {
                           ...
                           plot::Y(
                               ...
                               Color::Red),
                           plot::Y(
                               "measured_cop", [this]() { return footTasks[ContactState::Left]->measuredCoP().y(); },
                               Color::Blue, Style::Dashed),
                           plot::Y(
                               "target_cop", [this]() { return footTasks[ContactState::Left]->targetCoP().y(); },
                               Color::Red, Style::Solid),
                           plot::Y(
                               "modeled_cop", [this]() { return modeledCoPLeft_.y(); }, Color::Blue, Style::Solid));
             }),
  ...
  gui.addElement(
      ...
      Button("Plot Left CoP Model Tracking (x)",
             [this, &gui]() {
               gui.addPlot("Left CoP Model Tracking (x)", plot::X("t", [this]() { return t_; }),
                           plot::Y(
                               "support_min",
                               [this]() {
                                 if(inContact(ContactState::Left))
                           ...
                           plot::Y(
                               ...
                               Color::Red),
                           plot::Y(
                               "measured_cop", [this]() { return footTasks[ContactState::Left]->measuredCoP().x(); },
                               Color::Blue, Style::Dashed),
                           plot::Y(
                               "target_cop", [this]() { return footTasks[ContactState::Left]->targetCoP().x(); },
                               Color::Red, Style::Solid),
                           plot::Y(
                               "modeled_cop", [this]() { return modeledCoPLeft_.x(); }, Color::Blue, Style::Solid));
             }),
                   ...
                   plot::Y(
                       ...
                       [this]() {
                         if(inContact(ContactState::Left))
                         {
                           const auto & leftContact = contacts_.at(ContactState::Left);
                           const sva::PTransformd & X_0_lc = leftContact.surfacePose();
                           return X_0_lc.inv().dualMul(footTasks[ContactState::Left]->targetWrench()).force().z();
                         }
                         return 0.;
                       },
                       Color::Red, Style::Solid),
                   plot::Y(
                       "modeled_Fz", [this]() { return modeledFzLeft_; }, Color::Blue, Style::Solid));
             }),
