...
struct ExternalWrenchConfiguration
{
  ...
  /// Subtract the measured external wrenches
  bool subtractMeasuredValue = false;
  /// Subtract the target external wrenches
  bool subtractTargetValue = true;
  ...
  void load(const mc_rtc::Configuration & config)
  {
    ...
    config("subtract_target_value", subtractTargetValue);
  ...
  mc_rtc::Configuration save() const
  {
    ...
    config.add("subtract_target_value", subtractTargetValue);
